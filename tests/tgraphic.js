...
var NTI52404 = {size: 0, kind: 14, base: null, node: null, finalizer: null};
var NTI52439 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
...
NTI52439.base = NTI138;
var NNI52404 = {kind: 2, offset: 0, typ: null, name: null, len: 3, sons: [{kind: 1, offset: 0, typ: NTI52404, name: "PRINT_ALL", len: 0, sons: null}, 
{kind: 1, offset: 1, typ: NTI52404, name: "PRINT_FAILURES", len: 0, sons: null}, 
{kind: 1, offset: 2, typ: NTI52404, name: "PRINT_NONE", len: 0, sons: null}]};
NTI52404.node = NNI52404;
...
var abortonerror_52415 = [false];
var outputlevel_52416 = [0];
var coloroutput_52417 = [false];
var checkpoints_52419 = [null];
checkpoints_52419[0] = nimCopy(null, [], NTI52439);
var envoutlvl_53154 = /**/[makeNimstrLit("")];
coloroutput_52417[0] = false;
if ((0 < (envoutlvl_53154[0] != null ? envoutlvl_53154[0].length-1 : 0))) {
L1: do {
var opt_53414 = [0];
var res_53427 = 0;
L2: do {
L3: while (true) {
if (!(res_53427 <= 2)) break L3;
opt_53414[0] = res_53427;
if (eqStrings(cstrToNimstr(NTI52404.node.sons[opt_53414[0]].name), envoutlvl_53154[0])) {
outputlevel_52416[0] = opt_53414[0];
break L1;
}
